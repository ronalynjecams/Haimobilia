                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="/users/dashboard_sales" class="waves-effect"><i class="zmdi zmdi-view-dashboard"></i> <span> Dashboard </span> </a>
                            </li>    
                            <?php } 
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled"> 
                                    <li><a href="/collections/all_list?status=pending">Pending</a></li>
                                    <li><a href="/collections/all_list?status=accomplished">Accomplished</a></li> 
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="/users/add" class="waves-effect"><i class="zmdi zmdi-layers"></i> <span> Employees </span> </a>
                            </li>
                            <?php //} ?> 
                            <?php // if ($userRole == 'admin' ) { ?>
                            <li class="has_sub">
