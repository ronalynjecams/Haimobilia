                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select id="company_id" class="form-control help-block">
                                        ...
                                        <option value="<?php echo $quote_data['Quotation']['company_id']; ?>">
                                            <?php echo $quote_data['Company']['name']; ?>
                                        </option>
                                        <?php
                                        } else {
                                            echo '<option></option>';
                                        ...
                                        foreach ($companies as $client) {
                                            ?>
                                            <option value="<?php echo $client['Company']['id']; ?>">
                                                <?php echo $client['Company']['name']; ?>
                                            </option>
                                            <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo  $quote_prod['Product']['name']; ?>
                                        </td>
                                        <td>
                                            <?php echo  $quote_prod['QuotationProduct']['description']; ?>
                                            <?php if($quote_data['Quotation']['status'] == 'pending' || $quote_data['Quotation']['status'] == 'ongoing'){?>
                                            <button class="btn btn-default btn-xs update_desc" data-descid="<?php echo $quote_prod['QuotationProduct']['id']; ?>" data-descdata="<?php echo $quote_prod['QuotationProduct']['description']; ?>"><i class="fa fa-edit"></i></button>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control quoted_qty" <?php if($quote_data[ 'Quotation'][ 'status'] !='pending' && $quote_data[ 'Quotation'][ 'status'] !='ongoing' ){echo 'disabled';} ?> data-qtyid="
                                            <?php echo $quote_prod['QuotationProduct']['id']; ?>" value="
                                            <?php echo $quote_prod['QuotationProduct']['qty']; ?>">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control quoted_list_price" <?php if($quote_data[ 'Quotation'][ 'status'] !='pending' && $quote_data[ 'Quotation'][ 'status'] !='ongoing' ){echo 'disabled';} ?> data-listpriceid="
                                            <?php echo $quote_prod['QuotationProduct']['id']; ?>" value="
                                            <?php echo $quote_prod['QuotationProduct']['list_price']; ?>" min="1" step="1">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-danger btn-xs deleteProduct" data-id="<?php echo $quote_prod['QuotationProduct']['id'] ?>">x</button>
                                        </td>
                                    </tr>
                                    <?php 
                                        $ctr++;
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <input type="number" class="form-control" id="discount" value="<?php echo $quote_data['Quotation']['discount'] ?>"> </th>
                                        <th></th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" align="right"> </th>
                                        ...
                                        <th>
                                            <input type="number" class="form-control" id="delivery_amount" value="<?php echo $quote_data['Quotation']['delivery_amount'] ?>"> </th>
                                        <th></th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" align="right"> </th>
                                        ...
                                        <th>
                                            <input type="number" class="form-control" id="installation_amount" value="<?php echo $quote_data['Quotation']['installation_amount'] ?>"> </th>
                                        <th></th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" align="right"> </th>
                                        <th>Grand Total</th>
                                        <th>
                                            <input type="number" class="form-control" disabled id="grand_total" value="<?php echo $quote_data['Quotation']['grand_total'] ?>"> </th>
                                        <th></th>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea id="terms" class="form-control">
                                <?php echo $quote_data['Quotation']['terms'];?>
                            </textarea>
                        </div>
                    </div>
                </div>
